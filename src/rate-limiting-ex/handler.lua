...
local policies = require "kong.plugins.rate-limiting-ex.policies"
...
local function get_identifier(conf)
  ...
  if not identifier then
    if conf.ip_header ~= "" and conf.ip_header ~= nil and headers[conf.ip_header] then
      identifier = headers[conf.ip_header]
    else
...
function RateLimitingHandler:new()
  RateLimitingHandler.super.new(self, "rate-limiting-ex")
end
